...
/**
 * Represents a visit between two countries involving exchanges of people for a given year (if not, current).
 * Each visit stores guests, hosts, and calculates the best pairings (exchanges) between them.
 */
public class CountryVisit {
    ...
    // Best exchanges are found in a bruteforce | greedy logic.
