...
public class Exchange implements Serializable {
    ...
    public Exchange(Person host, Person guest) {
        this.host = host;
        this.guest = guest;
        this.libelle = "" + LocalDate.now().getYear() + "_" + guest.getShortCountry() + guest.getID() + "->" + host.getShortCountry() + host.getID();
    }
    ...
    /**
     * Adds a value to the affinity score, weighted by the criteria's ratio.
     * If the criteria is mandatory, a large penalty is added.
     */
    ...
    /**
     * Multiplies the affinity score by a value, weighted by the criteria's ratio.
     * If the criteria is mandatory, a large penalty is added.
     */
    ...
    */
    ...
    public String toTinyString() {
        // this.evaluateAffinity();
        return this.libelle +":"+this.getAffinityScore();
    }
